import { Button, CardActions, CardContent, TextField, Typography, Card } from '@material-ui/core';
    ...
    return ( <>
            ...
            <Card className={classes.card} elevation={6}>
                <CardContent>
                    ...
                    <TextField id='email' label="Email" type='email' className={classes.textField} margin="normal" /><br/>
